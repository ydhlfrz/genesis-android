...
assert len(manifest)==72, 'Expected 72 optimized UI, rarity, race and branding images'
...
print('PASS: all 72 required images verified in '+('APK' if archive else 'source'))
